          ...
          <div className="flex items-center gap-2.5">
            ...
            <span>
              ...
              <span className="text-[#9CA3AF]">
                {language === 'ky' 
                  ? '№1–2: 12с = 2 500 сом | №3–7: 12с = 2 800 сом | №8–11: 12с = Баасы такталууда | Бардык бөлмөлөр: 24с = 5 000 сом (Эртең мененки тамак: Маалымат такталууда).' 
                  : language === 'ru' 
                  ? '№1–2: 12ч = 2 500 сом | №3–7: 12ч = 2 800 сом | №8–11: 12ч = Цена уточняется | Все номера: 24ч = 5 000 сом (Завтрак: Информация уточняется).' 
                  : 'Rooms 1–2: 12h = 2,500 KGS | Rooms 3–7: 12h = 2,800 KGS | Rooms 8–11: 12h = Price TBD | All rooms: 24h = 5,000 KGS (Breakfast: Information to be confirmed).'}
              </span>
            </span>
          </div>
        </div>
